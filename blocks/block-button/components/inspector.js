...
export default class Inspector extends Component {
	...
	render() {
		...
		const buttonSizeOptions = [
			{ value: 'lvpa-button-size-small', label: __( 'Small' ) },
			{ value: 'lvpa-button-size-medium', label: __( 'Medium' ) },
			{ value: 'lvpa-button-size-large', label: __( 'Large' ) },
			{ value: 'lvpa-button-size-extralarge', label: __( 'Extra Large' ) },
		];

		// Button shape
		const buttonShapeOptions = [
			{ value: 'lvpa-button-shape-square', label: __( 'Square' ) },
			{ value: 'lvpa-button-shape-rounded', label: __( 'Rounded Square' ) },
			{ value: 'lvpa-button-shape-circular', label: __( 'Circular' ) },
		];
